...
All three read the same environment as the API and the worker (`agentos.store.factory`,
...
from agentos.core.models import Budget, EffectClass, WorkflowDefinition
from agentos.core.policy import OperatorPolicy, apply_ceiling, executor_allowed, policy_sha256
from agentos.core.seal import HmacKeyring, verify_seals
...
def _policy(report: Report | None = None) -> OperatorPolicy | None:
    from agentos.core.policy import load_policy
...
def _check_executors(report: Report) -> None:
    ...
    from agentos.plugins import describe, discover_executors
