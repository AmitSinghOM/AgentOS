"""`python -m dagentos.worker [--once]` — composition root for the worker process.
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="dagentos.worker")
    ...
    # AGENTOS_SNAPSHOT_EVERY (default 200; 0 disables): kept in step with dagentos/api/main.py,
