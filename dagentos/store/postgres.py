...
session advisory locks for per-run leases live in `dagentos/store/pg_lease.py`.
...
Schema management: numbered, forward-only, raw-SQL migrations in `dagentos/store/migrations.py`,
