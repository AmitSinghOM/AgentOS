"""Executor plugin discovery — composition-root code, never imported by `dagentos.core`.
...
`dagentos.core.ports.Executor` (or the executor class itself). Configuration comes from the
...
from dagentos.core.ports import Executor
